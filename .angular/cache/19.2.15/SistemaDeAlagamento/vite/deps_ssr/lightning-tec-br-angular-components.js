...
} from "./chunk-I34BAQCT.js";
import {
  CommonModule,
  NgStyle
} from "./chunk-CYHKBMRI.js";
...
var FormFieldService = class _FormFieldService {
  constructor() {
    this.valueChanged = new import_rxjs.Subject();
    this.alertState = new import_rxjs.Subject();
    this.enterPressed = new import_rxjs.Subject();
  }
  static {
...
var AlertService = class _AlertService {
  constructor() {
    this.wasOpenned = new import_rxjs.Subject();
    this.wasClosed = new import_rxjs.Subject();
  }
  static {
...
var ButtonService = class _ButtonService {
  constructor() {
    this.click = new import_rxjs.Subject();
    this.stateChanged = new import_rxjs.Subject();
  }
  static {
...
var ListItemService = class _ListItemService {
  constructor() {
    this.stateChanged = new import_rxjs.Subject();
    this.onClick = new import_rxjs.Subject();
  }
  static {
...
var LabelService = class _LabelService {
  constructor() {
    this.stateChanger = new import_rxjs.Subject();
  }
  static {
...
var TableService = class _TableService {
  constructor() {
    this.dataChange = new import_rxjs.Subject();
    this.rowOnSelect = new import_rxjs.Subject();
  }
  static {
...
var TableComponent = class _TableComponent {
  ...
  startListenToDataChange() {
    this.TableService.dataChange.pipe((0, import_rxjs.takeUntil)(this.destroy)).subscribe((model) => {
...
var ModalService = class _ModalService {
  constructor() {
    this.showModal = new import_rxjs.Subject();
    this.ClosedByConfirmation = new import_rxjs.Subject();
  }
  static {
