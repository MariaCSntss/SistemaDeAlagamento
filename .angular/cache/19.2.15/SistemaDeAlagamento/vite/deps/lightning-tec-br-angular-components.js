...
function FormFieldComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("ngModelChange", function FormFieldComponent_Conditional_0_Template_input_ngModelChange_2_listener() {
      ɵɵrestoreView(_r1);
      const ctx_r1 = ɵɵnextContext();
      return ɵɵresetView(ctx_r1.onValueChanged());
  ...
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
    ɵɵstyleProp("width", ctx_r1._Width + "px")("height", ctx_r1._Height + "px")("border-radius", ctx_r1._BorderRadius + "px")("border", ctx_r1._Border);
    ɵɵproperty("ngStyle", ctx_r1._BoxShadowsEnabled ? ɵɵpureFunction1(55, _c03, "\n    rgb(204, 219, 232)" + ctx_r1._FontSize * 0.1875 + "px " + ctx_r1._FontSize * 0.1875 + "px " + ctx_r1._FontSize * 0.375 + "px 0px inset,rgba(255, 255, 255, 0.5)" + ctx_r1._FontSize * -0.1875 + "px " + ctx_r1._FontSize * -0.1875 + "px " + ctx_r1._FontSize * 0.375 + "px " + ctx_r1._FontSize * 0.0625 + "px inset") : ɵɵpureFunction0(57, _c12));
    ɵɵadvance();
    ...
    ɵɵadvance();
    ɵɵstyleProp("color", ctx_r1._FontColor)("font-family", ctx_r1._FontFamily)("font-size", ctx_r1._FontSize + "px")("font-weight", ctx_r1._FontWeight)("width", ctx_r1._Width + "px")("margin-left", ctx_r1._FontSize * 0.5 + "px");
    ɵɵpropertyInterpolate("prefix", ctx_r1.NumberMaskPrefix);
...
function FormFieldComponent_Conditional_1_For_3_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
...
function FormFieldComponent_Conditional_1_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, FormFieldComponent_Conditional_1_For_3_Conditional_0_Template, 2, 1, "option");
  }
  if (rf & 2) {
    const option_r4 = ctx.$implicit;
    ɵɵconditional(option_r4.value != "" ? 0 : -1);
  }
}
function FormFieldComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "div", 2)(1, "select", 5);
    ...
    ɵɵrepeaterCreate(2, FormFieldComponent_Conditional_1_For_3_Template, 1, 1, null, null, _forTrack0);
    ɵɵelementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
    ɵɵstyleProp("width", ctx_r1._Width + "px")("height", ctx_r1._Height + "px")("padding", ctx_r1._FontSize * 0.4 + "px " + ctx_r1._FontSize * 0.8 + "px")("border-radius", ctx_r1._BorderRadius + "px")("border", ctx_r1._Border);
    ɵɵproperty("ngStyle", ctx_r1._BoxShadowsEnabled ? ɵɵpureFunction1(24, _c03, "\n    rgb(204, 219, 232)" + ctx_r1._FontSize * 0.1875 + "px " + ctx_r1._FontSize * 0.1875 + "px " + ctx_r1._FontSize * 0.375 + "px 0px inset,rgba(255, 255, 255, 0.5)" + ctx_r1._FontSize * -0.1875 + "px " + ctx_r1._FontSize * -0.1875 + "px " + ctx_r1._FontSize * 0.375 + "px " + ctx_r1._FontSize * 0.0625 + "px inset") : ɵɵpureFunction0(26, _c12));
    ɵɵadvance();
...
var _c2 = ["*"];
function ListItemComponent_For_12_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = ɵɵnextContext();
    ɵɵstyleProp("display", line_r1.TextLineEnabled ? "" : "none")("background-color", line_r1.TextLineBackgroundColor)("font-family", line_r1.TextLineFontFamily)("font-weight", line_r1.TextLineFontWeight)("color", ctx_r1._mouseover ? line_r1.TextLineFontColorHover : line_r1.TextLineFontColorNormal)("font-size", line_r1.TextLineFontSize + "px")("text-align", line_r1.TextLineTextAlign == null ? null : line_r1.TextLineTextAlign.toString());
    ɵɵadvance();
    ɵɵtextInterpolate1(" ", line_r1.TextLineText, " ");
  }
}
var _c3 = (a0) => ({
  "flex-direction": a0
...
function ModalComponent_Conditional_5_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
...
function ModalComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, ModalComponent_Conditional_5_Conditional_0_Template, 1, 1, "app-button", 2);
    ɵɵelement(1, "app-button", 2);
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵconditional(!ctx_r0.configModel.OnlyOkButtonEnabled ? 0 : -1);
    ɵɵadvance();
    ɵɵproperty("name", ctx_r0.configModel.BtnOkName);
  }
}
...
var FormFieldConfigModel = class {
  constructor(params) {
...
var IconsEnum;
(function(IconsEnum2) {
  IconsEnum2["Add"] = "fi fi-br-plus";
  IconsEnum2["AddFile"] = "fi fi-rr-add-document";
  IconsEnum2["AddUser"] = "fi fi-sr-user-add";
  IconsEnum2["Alert"] = "fi fi-sr-exclamation";
  IconsEnum2["Admin"] = "fi fi-rr-admin-alt";
  IconsEnum2["Arrow"] = "fi fi-rr-angle-small-left";
  IconsEnum2["Attention"] = "fi fi-rc-triangle-warning";
  IconsEnum2["Automate"] = "fi fi-tr-plan";
  IconsEnum2["Box"] = "fi fi-tr-box-open";
  IconsEnum2["Bug"] = "fi fi-sr-bug-fix";
  IconsEnum2["Calendar"] = "fi fi-br-calendar";
  IconsEnum2["CalendarTime"] = "fi fi-rr-calendar-clock";
  IconsEnum2["Camera"] = "fi fi-rr-camera";
  IconsEnum2["Check"] = "fi fi-br-check";
  IconsEnum2["Clock"] = "fi fi-rr-clock-three";
  IconsEnum2["Close"] = "fi fi-br-cross";
  IconsEnum2["Close_02"] = "fi fi-sc-cross";
  IconsEnum2["Company"] = "fi fi-rs-building";
  IconsEnum2["Customize"] = "fi fi-ss-customize";
  IconsEnum2["Dashboard"] = "fi fi-sr-chart-simple";
  ...
  IconsEnum2["EditFile"] = "fi fi-rr-file-edit";
  IconsEnum2["EyeClose"] = "fi fi-ss-eye-crossed";
  IconsEnum2["EyeOpen"] = "fi fi-ss-eye";
  IconsEnum2["FileAlert"] = "fi fi-ss-file-circle-info";
  IconsEnum2["Filter"] = "fi fi-sr-filter";
  IconsEnum2["Filter_Outline"] = "fi fi-tr-filter";
  IconsEnum2["Gear"] = "fi fi-rr-settings";
  IconsEnum2["Hamburger"] = "fi fi-br-menu-burger";
  IconsEnum2["History"] = "fi fi-rr-time-past";
  IconsEnum2["Home"] = "fi fi-sr-home";
  IconsEnum2["Info"] = "fi fi-rr-info";
  IconsEnum2["ItemClosed"] = "fi fi-tr-caret-down";
  IconsEnum2["ItemOpenned"] = "fi fi-rr-caret-down";
  IconsEnum2["Key"] = "fi fi-sr-key";
  IconsEnum2["Layers"] = "fi fi-rr-layers";
  IconsEnum2["LayersAdd"] = "fi fi-rr-layer-plus";
  IconsEnum2["Lightning"] = "fi fi-tr-bolt";
  IconsEnum2["List"] = "fi fi-tr-ballot";
  IconsEnum2["Location"] = "fi fi-ts-land-layer-location";
  IconsEnum2["Lubrificacao"] = "fi fi-rr-oil-can";
  IconsEnum2["Message"] = "fi fi-rr-comment";
  IconsEnum2["Money"] = "fi fi-ss-dollar";
  IconsEnum2["Money_02"] = "fi fi-ts-sack-dollar";
  ...
  IconsEnum2["Sales"] = "fi fi-rr-shopping-cart";
  IconsEnum2["Save"] = "fi fi-ss-disk";
  IconsEnum2["Save_Outline"] = "fi fi-br-disk";
  IconsEnum2["Search"] = "fi fi-br-search";
  IconsEnum2["SyncDB"] = "fi fi-tr-back-up";
  IconsEnum2["Tools"] = "fi fi-br-tools";
  IconsEnum2["Transfer"] = "fi fi-sr-exchange";
  IconsEnum2["User"] = "fi fi-sr-user";
  IconsEnum2["Users"] = "fi fi-sr-users";
  IconsEnum2["Wallet"] = "fi fi-rr-wallet";
})(IconsEnum || (IconsEnum = {}));
var FormFieldComponent = class _FormFieldComponent {
  ...
  startListenToStateChanged() {
    this.FormFieldService.stateChanged.subscribe((model) => {
      if (model.Name == this.Name()) {
        ...
        if (model.ComboValues != null && model.ComboValues != void 0 && model.ComboIds != null && model.ComboIds != void 0) {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      decls: 2,
      vars: 1,
      consts: [[1, "container", 3, "width", "height", "border-radius", "border", "ngStyle"], [1, "container", 3, "width", "height", "padding", "border-radius", "border", "ngStyle"], [1, "container", 3, "ngStyle"], [3, "ngModelChange", "keydown.enter", "ngModel", "prefix", "suffix", "mask", "showMaskTyped", "allowNegativeNumbers", "thousandSeparator", "type", "name", "placeholder"], [3, "click"], [3, "ngModelChange", "ngModel"]],
      template: function FormFieldComponent_Template(rf, ctx) {
        if (rf & 1) {
          ɵɵtemplate(0, FormFieldComponent_Conditional_0_Template, 4, 58, "div", 0)(1, FormFieldComponent_Conditional_1_Template, 4, 27, "div", 1);
        }
        if (rf & 2) {
          ɵɵconditional(ctx.FieldType == ctx.FormFieldTypes.TxtBox ? 0 : 1);
        }
      },
      dependencies: [FormsModule, NgSelectOption, ɵNgSelectMultipleOption, DefaultValueAccessor, SelectControlValueAccessor, NgControlStatus, NgModel, CommonModule, NgStyle, NgxMaskDirective],
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FormFieldComponent, [{
    ...
    args: [{
      ...
      template: `@if(FieldType == FormFieldTypes.TxtBox){\r
\r
    <div class="container" \r
    [style.width]="_Width +'px'"\r
    [style.height]="_Height +'px'"\r
    [style.border-radius]=" _BorderRadius +'px'"\r
    [style.border]="_Border"\r
    [ngStyle]=" _BoxShadowsEnabled ?\r
    {'box-shadow':'\r
...
\r
        <input\r
\r
            [(ngModel)]="this.Value"\r
            (ngModelChange)="onValueChanged()"\r
            prefix="{{NumberMaskPrefix}}"\r
            suffix="{{Sufixo}}"\r
            mask="{{Mask}}"\r
...
\r
        >\r
            @for(option of _Options ; track option.id ){\r
                @if(option.value !=''){\r
...
var TooltipStyleInjectorService = class _TooltipStyleInjectorService {
  ...
  static {
    this.ɵfac = function TooltipStyleInjectorService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _TooltipStyleInjectorService)(ɵɵinject(PLATFORM_ID));
    };
  }
  static {
    this.ɵprov = ɵɵdefineInjectable({
      token: _TooltipStyleInjectorService,
      factory: _TooltipStyleInjectorService.ɵfac,
      providedIn: "root"
    });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TooltipStyleInjectorService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
var ButtonComponent = class _ButtonComponent {
  constructor(element) {
    ...
    this.AlertService = inject(AlertService);
    this.TooltipService = inject(TooltipStyleInjectorService);
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      decls: 5,
      vars: 58,
      consts: [["type", "button", "mat-raised-button", "", "matTooltipClass", "tooltip", 3, "mouseover", "mouseout", "click", "matTooltip"], [3, "ngStyle"], [1, "loader"]],
      template: function ButtonComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          let tmp_9_0;
          let tmp_23_0;
          ɵɵstyleProp("background-color", ctx._BackGroundColor)("border-radius", ((tmp_1_0 = ctx.BorderRadius) !== null && tmp_1_0 !== void 0 ? tmp_1_0 : 5).toString() + "px")("border", ctx.ButtonType == ctx.ButtonTypeEnum.Outline && ctx.EnabledState ? `${ctx.OutlineBorderSize}px solid ${ctx.BorderColor}` : "")("width", ctx.Width + "px")("height", ctx.Height + "px")("flex-direction", ctx._IconOrientation)("align-items", ctx.AlignItems)("justify-content", ctx.JustifyContent)("padding", ctx.Padding)("cursor", ((tmp_9_0 = ctx.EnabledState) !== null && tmp_9_0 !== void 0 ? tmp_9_0 : true) ? "pointer" : "default")("--transition", !ctx.EnabledState ? "0s" : "0.05s")("--transformHover", !ctx.EnabledState ? "1" : "1.05")("--transformActive", !ctx.EnabledState ? "1" : "0.95");
          ɵɵpropertyInterpolate("matTooltip", ctx.TooltipText);
          ɵɵadvance();
          ɵɵclassMap(ctx.Icon);
          ɵɵstyleProp("color", ctx._IconColor)("font-size", ctx.IconFontSize + "px")("display", ctx.IconEnabled && !ctx.LoadingState ? "" : "none");
          ɵɵproperty("ngStyle", ctx._IconDistanceFromTextObject);
          ɵɵadvance();
          ɵɵstyleProp("width", ctx.IconFontSize + "px")("height", ctx.IconFontSize + "px")("display", ctx.LoadingState ? "inline-block" : "none")("--loaderColor", ctx.TextEnabled ? ctx._TextColor : ctx._IconColor)("--loaderBorderSize", ((tmp_23_0 = ctx.IconFontSize) !== null && tmp_23_0 !== void 0 ? tmp_23_0 : 12) * 0.15 + "px");
          ɵɵadvance();
          ɵɵstyleProp("font-size", ctx.TextFontSize + "px")("font-family", ctx.TextFontFamily)("font-weight", ctx.TextFontWeight)("color", ctx._TextColor)("display", ctx.TextEnabled && !ctx.LoadingState ? "" : "none");
          ɵɵadvance();
          ɵɵtextInterpolate1("", ctx.Text, " ");
        }
      },
      dependencies: [CommonModule, NgStyle, MatTooltipModule, MatTooltip],
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ButtonComponent, [{
    ...
    args: [{
      ...
      template: `<button\r
[style.background-color]="_BackGroundColor"\r
[style.border-radius]="(BorderRadius ?? 5).toString()+'px'"\r
[style.border]="ButtonType == ButtonTypeEnum.Outline && EnabledState ? \`\${OutlineBorderSize}px solid \${BorderColor}\` : '' "\r
[style.width]="Width + 'px'"\r
[style.height]="Height + 'px'"\r
[style.flex-direction]="this._IconOrientation"\r
[style.align-items]="AlignItems"\r
[style.justify-content]="JustifyContent"\r
[style.padding]="Padding"\r
...
\r
        ...
        [style.--loaderColor]="TextEnabled ? _TextColor : _IconColor"\r
...
var ListItemComponent = class _ListItemComponent {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      decls: 17,
      vars: 103,
      consts: [[1, "wrapper"], [1, "container", 3, "mouseover", "mouseout", "click"], [1, "iconContainer"], [1, "ItemNumber"], [1, "TextContainer"], [1, "title"], [1, "sub-title"], [1, "sub-title", 3, "display", "background-color", "font-family", "font-weight", "color", "font-size", "text-align"], [1, "ItemOpenIconContainer"], [1, "containerWrapped"]],
      template: function ListItemComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          ɵɵtext(10);
          ɵɵelementEnd();
          ɵɵrepeaterCreate(11, ListItemComponent_For_12_Template, 2, 15, "h2", 7, ɵɵrepeaterTrackByIndex);
          ɵɵelementEnd();
      ...
      styles: ["[_nghost-%COMP%]{display:inline-block;vertical-align:top}.wrapper[_ngcontent-%COMP%]{overflow:hidden}.wrapper[_ngcontent-%COMP%] > .container[_ngcontent-%COMP%]{display:flex;cursor:pointer}.wrapper[_ngcontent-%COMP%] > .container[_ngcontent-%COMP%] > .iconContainer[_ngcontent-%COMP%]{display:flex;flex-direction:row;align-items:center;justify-content:center;box-sizing:border-box}.wrapper[_ngcontent-%COMP%] > .container[_ngcontent-%COMP%] > .iconContainer[_ngcontent-%COMP%] > i[_ngcontent-%COMP%]{line-height:0px}.wrapper[_ngcontent-%COMP%] > .container[_ngcontent-%COMP%] > .TextContainer[_ngcontent-%COMP%]{display:flex;flex-direction:column;align-items:start;justify-content:center;width:100%;box-sizing:border-box}.wrapper[_ngcontent-%COMP%] > .container[_ngcontent-%COMP%] > .TextContainer[_ngcontent-%COMP%] > h1[_ngcontent-%COMP%], h2[_ngcontent-%COMP%]{margin:0;width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.wrapper[_ngcontent-%COMP%] > .container[_ngcontent-%COMP%] > .ItemOpenIconContainer[_ngcontent-%COMP%]{display:flex;flex-direction:column;align-items:center;justify-content:center}.wrapper[_ngcontent-%COMP%] > .container[_ngcontent-%COMP%] > .ItemOpenIconContainer[_ngcontent-%COMP%] > i[_ngcontent-%COMP%]{transition:.3s}.wrapper[_ngcontent-%COMP%] > .containerWrapped[_ngcontent-%COMP%]{padding:0}"]
    });
  }
};
(() => {
...
\r
        ...
        >\r
            ...
            [style.margin-right]="IconEnabled ? 'auto' : ''"\r
            [style.margin-left]="IconEnabled ? '5px' : ''"\r
            >\r
                {{ItemNumberText}}\r
            </p>\r
\r
...
\r
            @for(line of TextLines ; track $index){\r
                <h2 class="sub-title"\r
                    [style.display]="line.TextLineEnabled ? '' : 'none'"\r
                    [style.background-color]="line.TextLineBackgroundColor"\r
                    [style.font-family]="line.TextLineFontFamily"\r
                    [style.font-weight]="line.TextLineFontWeight"\r
                    [style.color]="_mouseover ? line.TextLineFontColorHover : line.TextLineFontColorNormal"\r
                    [style.font-size]="line.TextLineFontSize +'px'"\r
                    [style.text-align]="line.TextLineTextAlign?.toString()"\r
                    >\r
                        {{line.TextLineText}}\r
                </h2>\r
            }\r
...
\r
`,
      styles: [":host{display:inline-block;vertical-align:top}.wrapper{overflow:hidden}.wrapper>.container{display:flex;cursor:pointer}.wrapper>.container>.iconContainer{display:flex;flex-direction:row;align-items:center;justify-content:center;box-sizing:border-box}.wrapper>.container>.iconContainer>i{line-height:0px}.wrapper>.container>.TextContainer{display:flex;flex-direction:column;align-items:start;justify-content:center;width:100%;box-sizing:border-box}.wrapper>.container>.TextContainer>h1,h2{margin:0;width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.wrapper>.container>.ItemOpenIconContainer{display:flex;flex-direction:column;align-items:center;justify-content:center}.wrapper>.container>.ItemOpenIconContainer>i{transition:.3s}.wrapper>.containerWrapped{padding:0}\n"]
    }]
  }], null, null);
})();
var ListItemTextLineModel = class {
  constructor(params) {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      template: function LabelComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ɵɵproperty("ngStyle", ɵɵpureFunction1(22, _c3, ctx._IconOrientation));
          ɵɵadvance();
          ɵɵclassMap(ctx._Icon());
...
var ModalModel = class {
  constructor(params) {
    ...
    this.ModalMessageFontFamily = "";
    this.ModalMessageFontSize = 0;
    this.ModalMessageFontWeight = 0;
    this.ModalMessageColor = "";
    this.IsVisible = false;
    this.BtnCancelName = "";
    this.BtnOkName = "";
    this.Name = params.Name;
...
var ModalComponent = class _ModalComponent {
  ...
  startListenToStateChanged() {
    this.ModalService.stateChanged.subscribe((modalModel) => {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      decls: 6,
      vars: 24,
      consts: [[3, "animationend"], [1, "btns-container"], [3, "name"]],
      template: function ModalComponent_Template(rf, ctx) {
        if (rf & 1) {
          ɵɵelementStart(0, "section")(1, "form", 0);
          ɵɵlistener("animationend", function ModalComponent_Template_form_animationend_1_listener($event) {
          ...
          ɵɵtemplate(5, ModalComponent_Conditional_5_Template, 2, 2);
          ɵɵelementEnd()()();
        }
        if (rf & 2) {
          ɵɵstyleProp("display", ctx.displayOn ? "flex" : "none");
          ɵɵadvance();
          ɵɵstyleProp("padding", "32px 32px")("border-radius", "10px")("display", ctx.displayOn ? "flex" : "none");
          ɵɵclassProp("animation-slide-down", ctx.configModel.IsVisible)("animation-slide-up", !ctx.configModel.IsVisible);
          ɵɵadvance();
          ɵɵstyleProp("font-family", ctx.configModel.ModalMessageFontFamily)("font-size", ctx.configModel.ModalMessageFontSize + "px")("font-weight", ctx.configModel.ModalMessageFontWeight)("color", ctx.configModel.ModalMessageColor);
          ɵɵadvance();
          ɵɵtextInterpolate(ctx.configModel.ModalMessageText);
          ɵɵadvance();
          ɵɵstyleProp("padding-top", "10px");
          ɵɵadvance();
          ɵɵconditional(ctx.displayOn ? 5 : -1);
        }
      },
      dependencies: [ButtonComponent],
      styles: [".animation-slide-down[_ngcontent-%COMP%]{animation:_ngcontent-%COMP%_slide-down .7s cubic-bezier(.075,.82,.165,1)}@keyframes _ngcontent-%COMP%_slide-down{0%{transform:translateY(-100dvh)}to{transform:translateY(0)}}.animation-slide-up[_ngcontent-%COMP%]{animation:_ngcontent-%COMP%_slide-up .7s cubic-bezier(.075,.82,.165,1)}@keyframes _ngcontent-%COMP%_slide-up{0%{transform:translateY(0)}to{transform:translateY(-100dvh)}}section[_ngcontent-%COMP%]{position:fixed;z-index:1000;width:100dvw;height:100dvh;background:transparent;box-shadow:0 4px 30px #0000001a;backdrop-filter:blur(3.6px);-webkit-backdrop-filter:blur(3.6px);align-items:start;justify-content:center}section[_ngcontent-%COMP%] > form[_ngcontent-%COMP%]{background-color:#fff;flex-direction:column;box-shadow:#0000003d 0 3px 8px;width:40%;margin-top:80px}section[_ngcontent-%COMP%] > form[_ngcontent-%COMP%] > p[_ngcontent-%COMP%]{white-space:pre-line}section[_ngcontent-%COMP%] > form[_ngcontent-%COMP%] > .btns-container[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:end;flex-wrap:wrap;gap:15px}@media (max-width: 1024px){section[_ngcontent-%COMP%] > form[_ngcontent-%COMP%]{width:60%}}@media (max-width: 500px){section[_ngcontent-%COMP%] > form[_ngcontent-%COMP%]{width:70%}}"]
    });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ModalComponent, [{
    ...
    args: [{
      ...
      template: `<section\r
[style.display]="displayOn ? 'flex' : 'none'"\r
>\r
\r
    <form\r
    [style.padding]="'32px ' + '32px'"\r
    [style.border-radius]="'10px'"\r
    [class.animation-slide-down]="configModel.IsVisible"\r
    [class.animation-slide-up]="!configModel.IsVisible"\r
    [style.display]="displayOn ? 'flex' : 'none'"\r
    (animationend)="onAnimationEnd($event)"\r
    >\r
        <p\r
        [style.font-family]="configModel.ModalMessageFontFamily"\r
        [style.font-size]="configModel.ModalMessageFontSize + 'px'"\r
        [style.font-weight]="configModel.ModalMessageFontWeight"\r
        [style.color]="configModel.ModalMessageColor"\r
        >{{configModel.ModalMessageText}}</p>\r
\r
...
\r
        @if(this.displayOn){\r
            ...
            \r
            <app-button [name]="configModel.BtnOkName"/>\r
        }\r
\r
\r
        </div>\r
